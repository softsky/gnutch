...
public class SchedulerServiceTest extends TestCase {
    ...
    public void testAddRemoveListeners() throws SchedulerException{
        ...
        TimeoutListenerImpl timeoutListener = 
            new TimeoutListenerImpl();
    ...
    public void testSingleJob() throws SchedulerException {
        SchedulerService schedulerService = 
            new SchedulerService();
        try {
            schedulerService.getQuartzScheduler()
                .start();
            TimeoutListenerImpl timeoutListener = 
                new TimeoutListenerImpl();
            String key = "key-1";
    ...
    public void testMultipleSimultaneousJobs() throws SchedulerException {
        ...
        try {
            schedulerService.getQuartzScheduler()
                .start();
            TimeoutListenerImpl timeoutListener1 = 
                new TimeoutListenerImpl();
            String key1 = "key-1";
            TimeoutListenerImpl timeoutListener2 = 
                new TimeoutListenerImpl();
            String key2 = "key-2";
            schedulerService
                .addTimeoutListener(timeoutListener1);
            schedulerService
                .addTimeoutListener(timeoutListener2);
            Properties jobProperties = 
                new Properties();
