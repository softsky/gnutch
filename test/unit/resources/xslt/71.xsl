...
<xsl:stylesheet
  ...
  <gn:init>http://www.cinven.com/mediacentre/default.asp</gn:init>
  <gn:filter>
    +http://www.cinven.com/mediacentre/default.asp\?mediaid=\d*
  </gn:filter>
  <gn:index>http://www.cinven.com/mediacentre/default.asp\?mediaid=\d*</gn:index>
  ...
  <xsl:template match="div">
      <field name="title"><xsl:value-of select="h3[last()]"/></field>
      <field name="content">
